...
# SerialTransfer Class Contains Methods For Serial Communication Proccess between Laptop and Our Maze Robot 
# Methods in the Class :
# [1] __init__(self , port , baudRate ) > the constructor method takes 2 Parameters ( port_number , baud_rate [ optional ] )
# and set a default value for the baud rate to be 9600bps   

# [2] __del__(self)             > To Destroy or Delete a created object From the Memory
# [3] close(self)               > To Close the Connection
# [4] send(self , statement )   > Takes 1 Parameter to Send it through the serial port after checking if the serial port is opened or not 
# [5] recieve()                 > To Recieve coming data through the serial port if the port is opened  
